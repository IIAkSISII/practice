...
### Оформление сообщений
 ...
 У каждого коммита в Git есть сообщение — то, что передаётся после параметра `-m`. Сообщение коммита должно помочь определить, что внутри. Это краткое описание того, какие изменения несет за собой коммит.
